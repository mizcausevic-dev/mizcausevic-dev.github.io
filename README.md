...
- Page: <https://mizcausevic-dev.github.io/>
- AEO declaration: <https://mizcausevic-dev.github.io/.well-known/aeo.json>

## Deploy

Push to `main`. GitHub Pages rebuilds within ~60 seconds. `.nojekyll` is present so dotfile paths (like `.well-known/`) are served.

## Related

- AEO Protocol spec: [aeo-protocol-spec](https://github.com/mizcausevic-dev/aeo-protocol-spec)
- Profile and all active repositories: [github.com/mizcausevic-dev](https://github.com/mizcausevic-dev)
